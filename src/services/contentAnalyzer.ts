...
const TECH_KEYWORDS = new Set([
  // 程式設計
  'javascript', 'python', 'react', 'vue', 'angular', 'node', 'typescript', 'html', 'css', 'api', 'database', 'sql', 'mongodb', 'mysql',
  // 雲端和架構
  'aws', 'azure', 'docker', 'kubernetes', 'microservices', 'serverless', 'cloud', 'devops', 'ci/cd', 'github', 'git',
  // AI 和機器學習
  'ai', 'machine learning', 'deep learning', 'neural network', 'tensorflow', 'pytorch', 'nlp', 'computer vision',
  // 中文技術詞彙
  '人工智慧', '機器學習', '深度學習', '神經網路', '雲端', '容器', '微服務', '資料庫', '前端', '後端', '全端', '框架', '演算法', '程式碼', '開發'
]);
...
const TOPIC_KEYWORDS = {
  technical: ['程式', '開發', '技術', 'code', 'programming', 'development', 'software', 'system', 'architecture'],
  tutorial: ['教學', '指南', '步驟', '如何', 'tutorial', 'guide', 'how to', 'step by step', 'learn'],
...
function analyzeSentiment(text: string): 'positive' | 'neutral' | 'professional' {
  const positiveWords = ['好', '棒', '優秀', '推薦', '喜歡', 'good', 'great', 'excellent', 'recommend', 'amazing'];
  const professionalWords = ['分析', '研究', '探討', '實作', '架構', 'analysis', 'research', 'implementation', 'architecture'];
 ...
 * 內容複雜度分析
 */
function analyzeComplexity(words: string[], techTerms: string[]): 'simple' | 'moderate' | 'complex' {
